...
template <typename T> void block32x32_gather(ncnn::Mat &block, ncnn::Mat &map, int x_index, int y_index, int x_max, int place, accel::hw_gemm &inst) {
    // x_index block 在x方向的索引
    // y_index block 在y方向的索引
    // place = 1 -> 高位; place = 0  -> 低位
...
// simulation
    ...
    // printf_float32_mat(ofm_data_sim.channel(31));
    // printf_float32_mat(ofm_data_sim.channel(63));
    // printf("[ log ]: hardware data \n  ");
    // printf_float32_mat(ofm_data_ncnn.channel(31));
    // printf_float32_mat(ofm_data_ncnn.channel(63));
...
void test_layer_conv_batch() {
  ...
  void test_layer_conv_batch(){
    ...
    void test_layer_conv_batch() {
        ...
        // test_layer_conv(         16,        8,       32,       64,       1,       1,         0,          0,        0,           0,      0,             1,              0);
        // test_layer_conv(         16,        8,       32,       64,       1,       1,         0,          0,        0,           0);
        // test_layer_conv(        208,      208,       64,       64,       3,       1,         1,          1,        1,           1);
        ...
        // test_layer_conv(         189,       34,       113,     113,       3,       2,         0,          0,        1,           0,      1,             0);
        ...
        // test_layer_conv(          8,        8,        2,        2,       1,       1,         0,          0,        0,           0);
        // test_layer_conv(          8,        8,       32,       32,       1,       1,         0,          0,        0,           0);
        // test_layer_conv(          5,        5,        3,        3,       1,       1,         0,          0,        0,           0,      1);
        // test_layer_conv(          8,        8,       32,       32,       1,       1,         0,          0,        0,           0,      1);
