...
static int detect_yolov3(const cv::Mat& bgr, std::vector<Object>& objects)
{
    ...
    // if (yolov3.load_param_mem(yolov3.load_file2mem("models/yolov3/yolov3_opt.param")))
    //     exit(-1);
    // if (yolov3.load_model_mem(yolov3.load_file2mem("models/yolov3/yolov3_opt.bin")))
    //     exit(-1);

    if (yolov3.load_param_mem(yolov3.load_file2mem("models/yolov3/yolov3_int8.param")))
        exit(-1);
    if (yolov3.load_model_mem(yolov3.load_file2mem("models/yolov3/yolov3_int8.bin")))
        exit(-1);
