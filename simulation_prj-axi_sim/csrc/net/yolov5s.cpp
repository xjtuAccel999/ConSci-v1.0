...
static int detect_yolov5(const cv::Mat& bgr, std::vector<Object>& objects)
{
    ...
    if (yolov5.load_param_mem(yolov5.load_file2mem("models/yolov5s/yolov5s_int8.param")))
        exit(-1);
    if (yolov5.load_model_mem(yolov5.load_file2mem("models/yolov5s/yolov5s_int8.bin")))
        exit(-1);
