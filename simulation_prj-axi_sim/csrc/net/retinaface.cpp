...
static int detect_retinaface(const cv::Mat& bgr, std::vector<FaceObject>& faceobjects)
{
    ...
    if (retinaface.load_param_mem(retinaface.load_file2mem("models/retinaface/retinaface_opt.param")))
        exit(-1);
    if (retinaface.load_model_mem(retinaface.load_file2mem("models/retinaface/retinaface_opt.bin")))
        exit(-1);
