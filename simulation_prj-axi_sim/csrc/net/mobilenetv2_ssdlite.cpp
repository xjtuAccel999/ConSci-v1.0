...
static int detect_mobilenetv2(const cv::Mat& bgr, std::vector<Object>& objects)
{
    ...
    // if (mobilenetv2.load_param_mem(mobilenetv2.load_file2mem("models/mobilenetv2_ssdlite/mobilenetv2_ssdlite_int8.param")))
    //     exit(-1);
    // if (mobilenetv2.load_model_mem(mobilenetv2.load_file2mem("models/mobilenetv2_ssdlite/mobilenetv2_ssdlite_int8.bin")))
    //     exit(-1);

    if (mobilenetv2.load_param_mem(mobilenetv2.load_file2mem("models/mobilenetv2_ssdlite/mobilenetv2_ssdlite_opt.param")))
        exit(-1);
    if (mobilenetv2.load_model_mem(mobilenetv2.load_file2mem("models/mobilenetv2_ssdlite/mobilenetv2_ssdlite_opt.bin")))
        exit(-1);
